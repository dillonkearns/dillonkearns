...
| [elm-pages 12.1.0](https://package.elm-lang.org/packages/dillonkearns/elm-pages/12.1.0/) · [changelog](https://github.com/dillonkearns/elm-pages/blob/12.1.0/CHANGELOG-ELM.md#1210---2026-03-14) | Adds `Test.BackendTask` for pure testing of scripts and BackendTasks |
...
| [elm-ts-json 2.1.2](https://package.elm-lang.org/packages/dillonkearns/elm-ts-json/2.1.2/) · [changelog](https://github.com/dillonkearns/elm-ts-json/blob/2.1.2/CHANGELOG.md#212---2026-03-14) |  |
